	...
	<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			...
			<li class="nav-item active">
				<a class="nav-link" href="https://webappsubmission2.net/analyze.php">Analisis Gambar<span class="sr-only">(current)</span></a>
			</li>
		</div>
		</nav>
		<main role="main" class="container">
    		<div class="starter-template"> <br><br><br>
				...
				<p class="lead">Pilih Gambar Anda yang akan dianalisis.<br> Kemudian Klick <b>Upload</b>, untuk menganlisa gambar pilih <b>analyze</b> pada tabel.</p>
